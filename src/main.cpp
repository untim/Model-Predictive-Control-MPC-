    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          vector<double> ptsx = j[1]["ptsx"]; //x_location of road
          vector<double> ptsy = j[1]["ptsy"];// y_location of road
          double px = j[1]["x"]; //x-location of car
          ...
          */
          ...
          //.. add (x,y) points to list here, points are in reference to the vehicle's coordinate system
          // the purposoints in the simulator are connected by a Yellow line
